...
var brands = [
    new Brand({
        ...
        menuCard          : [
                                {   
                                    ...
                                    catNamesArray : ['Blackforest', 'Chocolate', 'Fruit', 'Truffle', 'Butterscotch', 'Indian flavor', 'Red velvet'],
                                    pdtArray : [
                                        {
    ...
    new Brand({
        ...
        address           : {
                                ...
                                resident : ['303, Gurudev appt., near shivsatya ground, gangapur road, Nashik - 422013']
        },
        menuCard          : [
                                {   
                                    name  : 'Fresh cream cakes',
